...
Backbone.ModelBinder = Backbone.Model.extend({
    ...
    bind:function (model, rootEl, attributeBindings) {
        ...
        if(attributeBindings){
            ...
            this.attributeBindings = $.extend(true, {}, attributeBindings);
        }
    ...
    _initializeDefaultAttributeBindings: function(){
        ...
        for(elCount = 0; elCount < namedEls.length; elCount++){
            ...
            if(!this.attributeBindings[name]){
                ...
                this.attributeBindings[name].elementBindings.push({attributeBinding: attributeBinding, boundEls: [namedEl]});
            }
        }
    },
