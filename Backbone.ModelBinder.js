...
(function (factory) {
     if (typeof define === 'function' && define.amd) {
       ...
       Backbone.ModelBinder.Constants.default_attribute = "name"; //this default should be changed to 'data-[something]' in your program. it's left as name for compatability
       ...
       _.extend(Backbone.ModelBinder.prototype, {
                    ...
                    _initializeDefaultBindings: function(){
                        var binding_name = Backbone.ModelBinder.Constants.default_attribute;
                        this._attributeBindings = {};
                        var namedEls = $('['+binding_name+']', this._rootEl);

                        for(var elCount = 0; elCount < namedEls.length; elCount++){
                            var namedEl = namedEls[elCount];
                            var name = $(namedEl).attr(binding_name);
