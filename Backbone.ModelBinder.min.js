...
(function(){if(!Backbone){throw'Please include Backbone.js before Backbone.ModelBinder.js';}
    ...
    else{el.html(convertedValue);}},_copyViewToModel:function(elementBinding,el){if(!elementBinding.isSetting){elementBinding.isSetting=true;this._setModel(elementBinding,$(el));elementBinding.isSetting=false;}},_setModel:function(elementBinding,el){var data={};var elVal;switch(el.attr('type')){case'checkbox':elVal=el.prop('checked')?true:false;break;default:elVal=el.val();}
